...
@section('content')
    @include('layouts.navbars.topnav', ['title' => 'Manage Patient'])
        <div class="">
        @if($errors->any())
        ...
        <div class="row mt-4 mx-4">
            <div class="col-12">
                    <div class="card mb-4">
                            ...
                            <form action="{{ URL('/create-patient') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" id="ExtPatientId" name="ExtPatientId" value="{{ $UserData[0]->id }}">
                                ...
                                <div class="img2"><img src="{{ url('/public/patient_photos/') }}/{{ $UserData[0]->profile_photo }}" style="width: 20%!important;" /></div>
                                ...
                                <?php } ?>
                                    <a href="{{ url('/admin_patients') }}" class="btn btn-danger">Back</a>
                            </form>
                            </div>
                    </div>
            </div>
