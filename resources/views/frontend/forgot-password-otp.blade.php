  ...
  <div class="container">
    <div class="login-box">
      ...
      <div class="login-right flex-column">
        <h2 class="h2-big text-center mb-4 d-flex justify-content-center w-100">Forgot Password</h2>
        <h2 class="h2-big flex-column text-center mb-4 d-flex justify-content-center w-100">Enter verification code sent on <small>{{ $user_row->email_address }}</small></h2>
        <div class="error-form">
         ...
         <div class="login-form otp-form mt-0">
                
            <form  id="ForgotPasswordOtp" action="{{ url('/') }}/forgot-password-otp/{{ Crypt::encrypt($user_row->id) }}" method="POST">
            @csrf
