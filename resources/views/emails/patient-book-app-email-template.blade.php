...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;"><?php if($rec_by == 'patient') { echo 'Thanks for booking an appointment on SecondLookOrtho. Here are the details of your appointment:'; } elseif($rec_by == 'doctor') { echo $patient->first_name.' '.$patient->last_name. ' has been Book an Appointment with you, Here are the details of your appointment:';}?></td>
    </tr>
    <tr>
