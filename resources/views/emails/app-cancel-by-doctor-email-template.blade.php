  ...
  <tbody>
    ...
    <tr>
        ...
        @elseif($rec_by == 'doctor')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Dear <strong style="color:#000; font-size:18px; font-weight:700;font-family: 'Georgia',serif,sans-serif;">{{ $doctor->first_name }} {{ $doctor->last_name }}</strong>,</td>
        @endif
    </tr>
    <tr>
    ...
    <tr>
        @if($rec_by == 'patient')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Your appointment with Dr. {{ $doctor->first_name }} {{ $doctor->last_name }} has been cancelled by doctor. Here are the details of the cancelled appointment:</td>
        @elseif($rec_by == 'doctor')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Your appointment with {{ $patient->first_name }} {{ $patient->last_name }} has been cancelled by you. Here are the details of the cancelled appointment:</td>
        @endif
    </tr>
    <tr>
      ...
      <td align="left" valign="top" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">
        <table cellpadding="0" cellspacing="0" style="width:100%;padding: 0 0px; margin:0 auto; border:1px solid #D9D9D9; border-bottom: none;box-shadow: 0px 0px 14px 2px #0000000D;background: #fff;" id="remove-border">
          ...
          <!-- <tr>
            ...
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; width:66.667%;border-bottom: 1px solid #D9D9D9; "><a href="{{ $app_details->phone_meeting_link }}" style="color:#0070D7;font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; ">{{ $app_details->phone_meeting_link }} </a></td>
          </tr> -->
          <tr>
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;width: 33.333%;border-right: 1px solid #D9D9D9;border-bottom: 1px solid #D9D9D9;">Reason</td>
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; width:66.667%;border-bottom: 1px solid #D9D9D9; "><strong>{{ $reason }}</strong></td>
          </tr>
        </table>
      </td>
    </tr>
