...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
        @if($rec_by == 'patient')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Thanks for booking an appointment on SecondLookOrtho. Your appointment with Dr. {{ $doctor->first_name }} {{ $doctor->last_name }} has been completed by doctor. Here are the details of the completed appointment:</td>
        @elseif($rec_by == 'doctor')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Your appointment with {{ $patient->first_name }} {{ $patient->last_name }} has been completed by you. Here are the details of the completed appointment:</td>
        @endif
    </tr>
    <tr>
