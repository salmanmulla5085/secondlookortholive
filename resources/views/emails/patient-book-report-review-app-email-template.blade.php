...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;"><?php if($rec_by == 'patient') { echo 'Thanks for submitting Report Review request on SecondLookOrtho. Here are the details of your Report Review request:'; } elseif($rec_by == 'doctor') { echo 'Patient has been requested Report Review with you, Here are the details of your Report Review request.:';}?></td>
    </tr>
    <tr>
