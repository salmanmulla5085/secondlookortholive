...
#remove-border td{border-right: none!important;}
  ...
  <?php 
    $msg = "Thank you for choosing SecondLookOrtho as your healthcare provider. We are committed to offering quality care and personalized services. If you have any questions or need assistance, please don’t hesitate to contact us. We look forward to being your partner in health.";
  ?>
...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">{{ $msg }}</td>
    </tr>
    <tr>
