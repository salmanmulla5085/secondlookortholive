...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
        @if($rec_by == 'patient')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Dr. {{ $doctor->first_name }} {{ $doctor->last_name }} has been replied to your Report Review request, Here are the details of your Report Review request:</td>
        @elseif($rec_by == 'doctor')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">You has been replied to {{ $patient->first_name }} {{ $patient->last_name }} Report Review request, Here are the details of Report Review request:</td>
        @endif
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" valign="top" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">
        <table cellpadding="0" cellspacing="0" style="width:100%;padding: 0 0px; margin:0 auto; border:1px solid #D9D9D9; border-bottom: none;box-shadow: 0px 0px 14px 2px #0000000D;background: #fff;" id="remove-border">
          ...
          <tr>
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;width: 33.333%;border-right: 1px solid #D9D9D9;border-bottom: 1px solid #D9D9D9;">Requested On</td>
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; width:66.667%;border-bottom: 1px solid #D9D9D9; "><strong>{{ \Carbon\Carbon::parse($app_details->start)->Format('j F Y') }} {{ \Carbon\Carbon::parse($app_details->start)->Format('G:i') }}</strong></td>
          </tr>
        </table>
      </td>
    </tr>
