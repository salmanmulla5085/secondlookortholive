...
#remove-border td{border-right: none!important;}
  ...
  <?php 
    ...
    $msg = "You have been added as doctor at SecondLookOrtho website.<br>";
    $msg .= "Your login credentials are as below.<br><br>";    

    $msg .= "username :$doctor->email_address <br>";
    $msg .= "password :$doctor->view_password<br>";
...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">
        Dear <strong style="color:#000; font-size:18px; font-weight:700;font-family: 'Georgia',serif,sans-serif;">
        {{ $doctor->first_name }} {{ $doctor->last_name }}</strong>,</td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">
        <?php echo $msg; ?>
        <br>
        Please click on below link and login;
        <br>
        <?php
        $url = URL('/')."/login/doctor";    
