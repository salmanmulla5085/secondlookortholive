...
<table  cellpadding="0" cellspacing="0" style="max-width: 960px; width:100%;padding: 0 0px 0rem 0; margin:0 auto; border:none; background: #F5F5FA !important;" id="main-tables">
  ...
  <tbody>
    ...
    <tr>
        @if($rec_by == 'patient')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Thanks for booking an appointment on SecondLookOrtho. your appointment with Dr. {{ $doctor->first_name }} {{ $doctor->last_name }} has been confirmed by doctor. Here are the details of the confirmed appointment:</td>
        @elseif($rec_by == 'doctor')
            <td align="left" valign="middle" style="color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif;padding:0px 50px;">Your appointment with {{ $patient->first_name }} {{ $patient->last_name }} has been confirmed by you. Here are the details of the confirmed appointment:</td>
        @endif
    </tr>
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;padding: 0 0px; margin:0 auto; border:1px solid #D9D9D9; border-bottom: none;box-shadow: 0px 0px 14px 2px #0000000D;background: #fff;" id="remove-border">
          ...
          <tr>
            ...
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; width:66.667%;border-bottom: 1px solid #D9D9D9; "><strong>
              {{ \Carbon\Carbon::parse($app_details->start)->Format('j F Y') }} 
              {{ \Carbon\Carbon::parse($app_details->start)->Format('G:i') }} 
                {{'to'}} 
              {{ \Carbon\Carbon::parse($app_details->end)->Format('G:i') }}</strong></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding:10px 15px;color:#000000; font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; width:66.667%;border-bottom: 1px solid #D9D9D9; "><a href="{{ $app_details->phone_meeting_link }}" style="color:#0070D7;font-size:18px; font-weight:500;font-family: 'Georgia',serif,sans-serif; ">Click here</a></td>
          </tr>
        </table>
      </td>
    </tr>
